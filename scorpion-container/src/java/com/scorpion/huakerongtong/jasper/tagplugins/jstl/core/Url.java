...
public class Url implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource("String " + baseUrlName + " = " +
                "com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.resolveUrl(" + valueName + ", " + contextName + ", pageContext);");
        ...
        ctxt.generateJavaSource("if(!com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + resultName + ")){");
