...
package com.scorpion.huakerongtong.jasper.tagplugins.jstl.core;

import com.scorpion.huakerongtong.jasper.compiler.tagplugin.TagPlugin;
import com.scorpion.huakerongtong.jasper.compiler.tagplugin.TagPluginContext;
import com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util;
...
public class Import implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource(iauName + " = " +
                "com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + urlName + ");");
        ...
        if(hasVarReader){
            ...
            ctxt.generateJavaSource("            " + charSetName + " = " +
                    "com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.getContentTypeAttribute(" + contentTypeName + ", \"charset\");");
            ctxt.generateJavaSource("            if(" + charSetName + " == null) " 
                    + charSetName + " = com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }else{");
            ctxt.generateJavaSource("            " + charSetName + " = com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        " + tempReaderName + " = new java.io.InputStreamReader(" + inputStreamName + ", com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING);");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("    RequestDispatcher " + requestDispatcherName + " = " + servletContextName + ".getRequestDispatcher(com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.stripSession("+urlName+"));");
            ctxt.generateJavaSource("    if(" + requestDispatcherName + " == null) throw new JspTagException(com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.stripSession("+urlName+"));");
            
            //initialize a ImportResponseWrapper to include the resource
            ctxt.generateJavaSource("    com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.ImportResponseWrapper " + irwName + " = new com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.ImportResponseWrapper((HttpServletResponse) pageContext.getResponse());");
            ctxt.generateJavaSource("    if(" + charSetName + " == null){");
            ctxt.generateJavaSource("        " + charSetName + " = com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        throw new JspTagException(" + irwName + ".getStatus()+\" \" + com.scorpion.huakerongtong.jasper.tagplugins.jstl.Util.stripSession(" + urlName + "));");
            ctxt.generateJavaSource("    }");
