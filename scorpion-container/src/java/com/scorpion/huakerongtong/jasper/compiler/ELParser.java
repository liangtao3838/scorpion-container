...
import com.scorpion.huakerongtong.jasper.compiler.ELNode.ELText;
import com.scorpion.huakerongtong.jasper.compiler.ELNode.Function;
import com.scorpion.huakerongtong.jasper.compiler.ELNode.Root;
import com.scorpion.huakerongtong.jasper.compiler.ELNode.Text;
            ...
            if (quote == '\'' || quote == '\"') {
                if (trimmed.charAt(trimmedLen - 1) != quote) {
                    throw new IllegalArgumentException(Localizer.getMessage(
                            "com.scorpion.huakerongtong.jasper.compiler.ELParser.invalidQuotesForStringLiteral",
                            input));
                }
        ...
        while (hasNextChar()) {
            ...
            if (ch == '\\') {
                ...
                if (ch == '\\' || ch == '\'' || ch == '\"') {
                    ...
                    throw new IllegalArgumentException(Localizer.getMessage(
                            "com.scorpion.huakerongtong.jasper.compiler.ELParser.invalidQuoting",
                            expression));
                }
            } else if (ch == quote) {
                buf.append(ch);
