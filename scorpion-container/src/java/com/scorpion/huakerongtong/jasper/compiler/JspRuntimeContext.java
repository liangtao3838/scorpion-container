...
import com.scorpion.huakerongtong.jasper.runtime.JspFactoryImpl;
import com.scorpion.huakerongtong.jasper.security.SecurityClassLoad;
import com.scorpion.huakerongtong.jasper.servlet.JspServletWrapper;
...
public final class JspRuntimeContext {
    ...
    static {
        ...
        if( System.getSecurityManager() != null ) {
            String basePackage = "com.scorpion.huakerongtong.jasper.";
            try {
    ...
    public JspRuntimeContext(ServletContext context, Options options) {
        ...
        if (context instanceof com.scorpion.huakerongtong.jasper.servlet.JspCServletContext) {
            codeSource = null;
    ...
    private SecurityHolder initSecurity() {
        ...
        if( policy != null ) {
            try {          
                ...
                // Allow the JSP to access com.scorpion.huakerongtong.jasper.runtime.HttpJspBase
                permissions.add( new RuntimePermission(
                    "accessClassInPackage.com.scorpion.huakerongtong.jasper.runtime") );
