...
class DirectJDKLog implements Log {
    ...
    private static final String SIMPLE_CFG="com.scorpion.huakerongtong.juli.JdkLoggerConfig"; //doesn't exist
    private static final String FORMATTER="com.scorpion.huakerongtong.juli.formatter";
