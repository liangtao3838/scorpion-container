...
package com.scorpion.huakerongtong.el.util;
    ...
    static {
        ...
        if (IS_SECURITY_ENABLED) {
                    ...
                    new PrivilegedAction<String>(){
                        ...
                        public String run() {
                            return System.getProperty(
                                    "com.scorpion.huakerongtong.el.parser.SKIP_IDENTIFIER_CHECK",
                                    "false");
                        }
                    }
            );
            ...
            skipIdentifierCheckStr = System.getProperty(
                    "com.scorpion.huakerongtong.el.parser.SKIP_IDENTIFIER_CHECK", "false");
        }
