...
import com.scorpion.huakerongtong.turnip.authenticator.AuthenticatorBase;
import com.scorpion.huakerongtong.turnip.comet.CometEvent;
import com.scorpion.huakerongtong.turnip.comet.CometEvent.EventType;
import com.scorpion.huakerongtong.turnip.core.AsyncContextImpl;
import com.scorpion.huakerongtong.turnip.util.ServerInfo;
import com.scorpion.huakerongtong.turnip.util.SessionConfig;
import com.scorpion.huakerongtong.turnip.util.URLEncoder;
import com.scorpion.huakerongtong.coyote.ActionCode;
import com.scorpion.huakerongtong.coyote.Adapter;
...
import com.scorpion.huakerongtong.rabbit.util.buf.CharChunk;
...
public class CoyoteAdapter implements Adapter {
    ...
    protected static final boolean ALLOW_BACKSLASH =
        Boolean.parseBoolean(System.getProperty("com.scorpion.huakerongtong.turnip.connector.CoyoteAdapter.ALLOW_BACKSLASH", "false"));
     ...
     */
    @Override
    public boolean event(com.scorpion.huakerongtong.coyote.Request req,
            com.scorpion.huakerongtong.coyote.Response res, SocketStatus status) {
    ...
    @Override
    public boolean asyncDispatch(com.scorpion.huakerongtong.coyote.Request req,
            com.scorpion.huakerongtong.coyote.Response res, SocketStatus status) throws Exception {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
     ...
     */
    @Override
    public void service(com.scorpion.huakerongtong.coyote.Request req,
                        com.scorpion.huakerongtong.coyote.Response res)
        throws Exception {
    ...
    @Override
    public void errorDispatch(com.scorpion.huakerongtong.coyote.Request req,
            com.scorpion.huakerongtong.coyote.Response res) {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
    ...
    @Override
    public void log(com.scorpion.huakerongtong.coyote.Request req,
            com.scorpion.huakerongtong.coyote.Response res, long time) {
    ...
    @Override
    public void checkRecycled(com.scorpion.huakerongtong.coyote.Request req,
            com.scorpion.huakerongtong.coyote.Response res) {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
     ...
     */
    protected boolean postParseRequest(com.scorpion.huakerongtong.coyote.Request req,
                                       Request request,
                                       com.scorpion.huakerongtong.coyote.Response res,
                                       Response response)
            throws Exception {
    ...
    private void doConnectorAuthenticationAuthorization(com.scorpion.huakerongtong.coyote.Request req, Request request) {
     ...
     * @param request
     */
    protected void parsePathParameters(com.scorpion.huakerongtong.coyote.Request req,
            Request request) {
     ...
     */
    protected void parseSessionCookiesId(com.scorpion.huakerongtong.coyote.Request req, Request request) {
