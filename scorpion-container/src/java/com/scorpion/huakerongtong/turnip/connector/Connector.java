...
import com.scorpion.huakerongtong.turnip.core.AprLifecycleListener;
...
import com.scorpion.huakerongtong.rabbit.util.http.mapper.Mapper;
...
public class Connector extends LifecycleMBeanBase  {
    ...
    public static final boolean RECYCLE_FACADES =
        Boolean.parseBoolean(System.getProperty("com.scorpion.huakerongtong.turnip.connector.RECYCLE_FACADES", "false"));
    ...
    protected static final String info =
        "com.scorpion.huakerongtong.turnip.connector.Connector/2.1";
    ...
    public String getProtocol() {
        ...
        if ("com.scorpion.huakerongtong.coyote.http11.Http11Protocol".equals
            (getProtocolHandlerClassName())
            || "com.scorpion.huakerongtong.coyote.http11.Http11AprProtocol".equals
            (getProtocolHandlerClassName())) {
            return "HTTP/1.1";
        } else if ("com.scorpion.huakerongtong.coyote.ajp.AjpProtocol".equals
                   (getProtocolHandlerClassName())
                   || "com.scorpion.huakerongtong.coyote.ajp.AjpAprProtocol".equals
                   (getProtocolHandlerClassName())) {
            return "AJP/1.3";
        }
        ...
        if (AprLifecycleListener.isAprAvailable()) {
            if ("HTTP/1.1".equals(protocol)) {
                setProtocolHandlerClassName
                    ("com.scorpion.huakerongtong.coyote.http11.Http11AprProtocol");
            } else if ("AJP/1.3".equals(protocol)) {
                setProtocolHandlerClassName
                    ("com.scorpion.huakerongtong.coyote.ajp.AjpAprProtocol");
            ...
            if ("HTTP/1.1".equals(protocol)) {
                ...
                setProtocolHandlerClassName
                    ("com.scorpion.huakerongtong.coyote.ajp.AjpProtocol");
            } else if (protocol != null) {
                setProtocolHandlerClassName(protocol);
            }
        }
    ...
    public String getExecutorName() {
        ...
        if (obj instanceof com.scorpion.huakerongtong.turnip.Executor) {
            return ((com.scorpion.huakerongtong.turnip.Executor) obj).getName();
        }
        return "Internal";
    }
