...
import com.scorpion.huakerongtong.turnip.security.SecurityUtil;
import com.scorpion.huakerongtong.turnip.util.DateTool;
...
import com.scorpion.huakerongtong.rabbit.util.buf.UEncoder;
import com.scorpion.huakerongtong.rabbit.util.buf.UEncoder.SafeCharsSet;
...
import com.scorpion.huakerongtong.rabbit.util.http.ResponseUtil;
import com.scorpion.huakerongtong.rabbit.util.http.ServerCookie;
import com.scorpion.huakerongtong.rabbit.util.http.parser.MediaTypeCache;
import com.scorpion.huakerongtong.rabbit.util.net.URL;
...
public class Response implements HttpServletResponse {
    ...
    static {
        ...
        ENFORCE_ENCODING_IN_GET_WRITER = Boolean.parseBoolean(
                System.getProperty("com.scorpion.huakerongtong.turnip.connector.Response.ENFORCE_ENCODING_IN_GET_WRITER",
                        "true"));
    }
     ...
     */
    protected static final String info = "com.scorpion.huakerongtong.coyote.catalina.CoyoteResponse/1.0";
     ...
     * Coyote response.
     */
    protected com.scorpion.huakerongtong.coyote.Response coyoteResponse;
     ...
     */
    public void setCoyoteResponse(com.scorpion.huakerongtong.coyote.Response coyoteResponse) {
     ...
     */
    public com.scorpion.huakerongtong.coyote.Response getCoyoteResponse() {
     ...
     */
    public com.scorpion.huakerongtong.turnip.connector.Request getRequest() {
        return (this.request);
    }
     ...
     */
    public void setRequest(com.scorpion.huakerongtong.turnip.connector.Request request) {
    ...
    /**
     * An extended version of this exists in {@link com.scorpion.huakerongtong.coyote.Response}.
     ...
     * since usingWriter is not visible to {@link com.scorpion.huakerongtong.coyote.Response}
     *
