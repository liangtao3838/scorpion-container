 ...
 */
package com.scorpion.huakerongtong.turnip.connector;
...
import com.scorpion.huakerongtong.turnip.core.ApplicationPart;
import com.scorpion.huakerongtong.turnip.core.ApplicationSessionCookieConfig;
import com.scorpion.huakerongtong.turnip.core.AsyncContextImpl;
import com.scorpion.huakerongtong.turnip.realm.GenericPrincipal;
import com.scorpion.huakerongtong.turnip.util.ParameterMap;
import com.scorpion.huakerongtong.turnip.util.RequestUtil;
import com.scorpion.huakerongtong.turnip.util.StringParser;
import com.scorpion.huakerongtong.turnip.util.URLEncoder;
import com.scorpion.huakerongtong.coyote.ActionCode;
import com.scorpion.huakerongtong.coyote.http11.upgrade.servlet31.HttpUpgradeHandler;
...
import com.scorpion.huakerongtong.rabbit.util.buf.B2CConverter;
import com.scorpion.huakerongtong.rabbit.util.buf.ByteChunk;
import com.scorpion.huakerongtong.rabbit.util.buf.MessageBytes;
import com.scorpion.huakerongtong.rabbit.util.buf.UDecoder;
import com.scorpion.huakerongtong.rabbit.util.compat.JreCompat;
import com.scorpion.huakerongtong.rabbit.util.http.Cookies;
import com.scorpion.huakerongtong.rabbit.util.http.FastHttpDateFormat;
import com.scorpion.huakerongtong.rabbit.util.http.Parameters;
import com.scorpion.huakerongtong.rabbit.util.http.Parameters.FailReason;
import com.scorpion.huakerongtong.rabbit.util.http.ServerCookie;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.FileItem;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.FileUploadBase;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.FileUploadBase.InvalidContentTypeException;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.FileUploadException;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.disk.DiskFileItemFactory;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.servlet.ServletFileUpload;
import com.scorpion.huakerongtong.rabbit.util.http.fileupload.servlet.ServletRequestContext;
import com.scorpion.huakerongtong.rabbit.util.http.mapper.MappingData;
import com.scorpion.huakerongtong.rabbit.util.net.SSLSupport;
...
public class Request
     ...
     * Coyote request.
     */
    protected com.scorpion.huakerongtong.coyote.Request coyoteRequest;
     ...
     */
    public void setCoyoteRequest(com.scorpion.huakerongtong.coyote.Request coyoteRequest) {
     ...
     */
    public com.scorpion.huakerongtong.coyote.Request getCoyoteRequest() {
    ...
    protected static final String info =
        "com.scorpion.huakerongtong.coyote.catalina.CoyoteRequest/1.0";
     ...
     */
    protected com.scorpion.huakerongtong.turnip.connector.Response response = null;

    /**
     * Return the Response with which this Request is associated.
     */
    public com.scorpion.huakerongtong.turnip.connector.Response getResponse() {
     ...
     */
    public void setResponse(com.scorpion.huakerongtong.turnip.connector.Response response) {
     ...
     * have names starting with "com.scorpion.huakerongtong.rabbit" and include:
     * <ul>
    ...
    public void removeAttribute(String name) {
        ...
        if (name.startsWith("com.scorpion.huakerongtong.rabbit.")) {
    ...
    public String getContextPath() {
        ...
        candidate = com.scorpion.huakerongtong.rabbit.util.http.RequestUtil.normalize(candidate);
     ...
     */
    @Deprecated
    public void doUpgrade(com.scorpion.huakerongtong.coyote.http11.upgrade.UpgradeInbound inbound)
            throws IOException {
        ...
        try {
            ...
            if (enc != null) {
                ...
                parameters.setEncoding
                    (com.scorpion.huakerongtong.coyote.Constants.DEFAULT_CHARACTER_ENCODING);
                if (useBodyEncodingForURI) {
