...
import com.scorpion.huakerongtong.turnip.authenticator.NonLoginAuthenticator;
import com.scorpion.huakerongtong.turnip.connector.Connector;
import com.scorpion.huakerongtong.turnip.core.ContainerBase;
import com.scorpion.huakerongtong.turnip.core.NamingContextListener;
...
import com.scorpion.huakerongtong.turnip.core.StandardServer;
import com.scorpion.huakerongtong.turnip.core.StandardService;
import com.scorpion.huakerongtong.turnip.core.StandardWrapper;
...
import com.scorpion.huakerongtong.turnip.realm.RealmBase;
 ...
 * implemented in com.scorpion.huakerongtong.turnip.startup.Bootstrap.
 *
 * <p>
...
public class Tomcat {
    ...
    static final String[] silences = new String[] {
        "com.scorpion.huakerongtong.coyote.http11.Http11Protocol",
        "com.scorpion.huakerongtong.turnip.core.StandardService",
        "com.scorpion.huakerongtong.turnip.core.StandardEngine",
        "com.scorpion.huakerongtong.turnip.startup.ContextConfig",
        "com.scorpion.huakerongtong.turnip.core.ApplicationContext",
        "com.scorpion.huakerongtong.turnip.core.AprLifecycleListener"
    };
    ...
    public void enableNaming() {
        ...
        String value = "com.scorpion.huakerongtong.naming";
        String oldValue =
        ...
        if (value == null) {
            System.setProperty
                (javax.naming.Context.INITIAL_CONTEXT_FACTORY,
                 "com.scorpion.huakerongtong.naming.java.javaURLContextFactory");
        }
    }
    ...
    public static void initWebappDefaults(Context ctx) {
        ...
        Wrapper servlet = addServlet(
                ctx, "default", "com.scorpion.huakerongtong.turnip.servlets.DefaultServlet");
        servlet.setLoadOnStartup(1);
        servlet.setOverridable(true);

        // JSP servlet (by class name - to avoid loading all deps)
        servlet = addServlet(
                ctx, "jsp", "com.scorpion.huakerongtong.jasper.servlet.JspServlet");
