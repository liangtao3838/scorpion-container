...
import com.scorpion.huakerongtong.juli.ClassLoaderLogManager;
...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        digester.addObjectCreate("Server",
                                 "com.scorpion.huakerongtong.turnip.core.StandardServer",
                                 "className");
        digester.addSetProperties("Server");
        digester.addSetNext("Server",
                            "setServer",
                            "com.scorpion.huakerongtong.turnip.Server");

        digester.addObjectCreate("Server/GlobalNamingResources",
                                 "com.scorpion.huakerongtong.turnip.deploy.NamingResources");
        ...
        digester.addSetNext("Server/Service",
                            "addService",
                            "com.scorpion.huakerongtong.turnip.Service");
        ...
        digester.addObjectCreate("Server/Service/Executor",
                         "com.scorpion.huakerongtong.turnip.core.StandardThreadExecutor",
                         "className");
        digester.addSetProperties("Server/Service/Executor");

        digester.addSetNext("Server/Service/Executor",
                            "addExecutor",
                            "com.scorpion.huakerongtong.turnip.Executor");
        ...
        digester.addSetNext("Server/Service/Connector",
                            "addConnector",
                            "com.scorpion.huakerongtong.turnip.connector.Connector");
    ...
    private void addClusterRuleSet(Digester digester, String prefix) {
        ...
        try {
            clazz = Class.forName("com.scorpion.huakerongtong.turnip.ha.ClusterRuleSet");
    ...
    public void load() {
        ...
        try {
            ...
            if (Boolean.getBoolean("com.scorpion.huakerongtong.turnip.startup.EXIT_ON_INIT_FAILURE")) {
    ...
    protected void usage() {
        ...
        System.out.println
            ("usage: java com.scorpion.huakerongtong.turnip.startup.Catalina"
             + " [ -config {pathname} ]"
             + " [ -nonaming ] "
             + " { -help | start | stop }");
