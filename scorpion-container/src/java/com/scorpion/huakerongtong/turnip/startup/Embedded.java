...
import com.scorpion.huakerongtong.turnip.security.SecurityConfig;
...
import com.scorpion.huakerongtong.rabbit.util.log.SystemLogHandler;
 ...
 * this object.
 * <p>
 * @see com.scorpion.huakerongtong.turnip.startup.Bootstrap#main For a complete example
...
public class Embedded  extends StandardService {
    ...
    protected static final String info =
        "com.scorpion.huakerongtong.turnip.startup.Embedded/1.0";
    ...
    public Connector createConnector(String address, int port,
        ...
        try {
            ...
            if (protocol.equals("ajp")) {
                connector = new Connector("com.scorpion.huakerongtong.coyote.ajp.AjpProtocol");
            } else if (protocol.equals("memory")) {
                connector = new Connector("com.scorpion.huakerongtong.coyote.memory.MemoryProtocolHandler");
     ...
     * implement the com.scorpion.huakerongtong.turnip.Valve interface
     */
     ...
     * {@link com.scorpion.huakerongtong.turnip.util.LifecycleBase#startInternal()}.
     *
     ...
     * implement the requirements of
     * {@link com.scorpion.huakerongtong.turnip.util.LifecycleBase#stopInternal()}.
     *
     * @exception LifecycleException if this component detects a fatal error
