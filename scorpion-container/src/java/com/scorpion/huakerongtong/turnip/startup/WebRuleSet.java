...
import com.scorpion.huakerongtong.turnip.deploy.ResourceBase;
...
import com.scorpion.huakerongtong.rabbit.util.digester.CallMethodRule;
import com.scorpion.huakerongtong.rabbit.util.digester.CallParamRule;
import com.scorpion.huakerongtong.rabbit.util.digester.Digester;
import com.scorpion.huakerongtong.rabbit.util.digester.Rule;
import com.scorpion.huakerongtong.rabbit.util.digester.RuleSetBase;
import com.scorpion.huakerongtong.rabbit.util.digester.SetNextRule;
...
public class WebRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addObjectCreate(fullPrefix + "/error-page",
                                 "com.scorpion.huakerongtong.turnip.deploy.ErrorPage");
        ...
        digester.addObjectCreate(fullPrefix + "/filter",
                                 "com.scorpion.huakerongtong.turnip.deploy.FilterDef");
        ...
        digester.addObjectCreate(fullPrefix + "/filter-mapping",
                                 "com.scorpion.huakerongtong.turnip.deploy.FilterMap");
        ...
        digester.addObjectCreate(fullPrefix + "/jsp-config/jsp-property-group",
                                 "com.scorpion.huakerongtong.turnip.deploy.JspPropertyGroup");
        ...
        digester.addObjectCreate(fullPrefix + "/login-config",
                                 "com.scorpion.huakerongtong.turnip.deploy.LoginConfig");
        ...
        digester.addObjectCreate(fullPrefix + "/security-constraint",
                                 "com.scorpion.huakerongtong.turnip.deploy.SecurityConstraint");
        ...
        digester.addObjectCreate(fullPrefix + "/security-constraint/web-resource-collection",
                                 "com.scorpion.huakerongtong.turnip.deploy.SecurityCollection");
        ...
        digester.addSetNext(fullPrefix + "/servlet",
                            "addServlet",
                            "com.scorpion.huakerongtong.turnip.deploy.ServletDef");
        ...
        digester.addObjectCreate(fullPrefix + "/servlet/security-role-ref",
                                 "com.scorpion.huakerongtong.turnip.deploy.SecurityRoleRef");
        ...
        digester.addObjectCreate(fullPrefix + "/servlet/multipart-config",
                                 "com.scorpion.huakerongtong.turnip.deploy.MultipartDef");
        ...
        digester.addObjectCreate(fullPrefix + "/session-config",
                                 "com.scorpion.huakerongtong.turnip.deploy.SessionConfig");
    ...
    protected void configureNamingRules(Digester digester) {
        ...
        digester.addObjectCreate(fullPrefix + "/message-destination",
                                 "com.scorpion.huakerongtong.turnip.deploy.MessageDestination");
        ...
        digester.addObjectCreate(fullPrefix + "/message-destination-ref",
                                 "com.scorpion.huakerongtong.turnip.deploy.MessageDestinationRef");
        ...
        digester.addObjectCreate(fullPrefix + "/service-ref/handler",
                                 "com.scorpion.huakerongtong.turnip.deploy.ContextHandler");
 ...
 * <code>com.scorpion.huakerongtong.turnip.deploy.SecurityConstraint</code>.
 */
 ...
 * on the stack, which must be a <code>com.scorpion.huakerongtong.turnip.Context</code>.
 */
