 ...
 */
package com.scorpion.huakerongtong.turnip.util;
...
public final class RequestUtil {
    ...
    private static final StringManager sm =
        StringManager.getManager("com.scorpion.huakerongtong.turnip.util");
     ...
     *             com.scorpion.huakerongtong.rabbit.util.http.RequestUtil#normalize(String)} as
     *             a replacement.
     */
    @Deprecated
    public static String normalize(String path) {
        return com.scorpion.huakerongtong.rabbit.util.http.RequestUtil.normalize(path);
    }
     ...
     * @deprecated Deprecated to resolve a circular package dependency and will
     *             be removed in Tomcat 8.0.x. Use {@link
     *             com.scorpion.huakerongtong.rabbit.util.http.RequestUtil#normalize(String,
