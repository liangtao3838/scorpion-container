...
import com.scorpion.huakerongtong.turnip.authenticator.SingleSignOn;
...
import com.scorpion.huakerongtong.turnip.realm.DataSourceRealm;
import com.scorpion.huakerongtong.turnip.realm.JDBCRealm;
import com.scorpion.huakerongtong.turnip.realm.JNDIRealm;
import com.scorpion.huakerongtong.turnip.realm.MemoryRealm;
import com.scorpion.huakerongtong.turnip.realm.UserDatabaseRealm;
import com.scorpion.huakerongtong.turnip.session.StandardManager;
import com.scorpion.huakerongtong.turnip.startup.ContextConfig;
import com.scorpion.huakerongtong.turnip.startup.HostConfig;
import com.scorpion.huakerongtong.turnip.util.LifecycleMBeanBase;
import com.scorpion.huakerongtong.turnip.valves.AccessLogValve;
import com.scorpion.huakerongtong.turnip.valves.RemoteAddrValve;
import com.scorpion.huakerongtong.turnip.valves.RemoteHostValve;
import com.scorpion.huakerongtong.turnip.valves.ValveBase;


/**
 * <p>A <strong>ModelMBean</strong> implementation for the
 * <code>com.scorpion.huakerongtong.turnip.core.StandardServer</code> component.</p>
 *
 * @author Amy Roh
 */
public class MBeanFactory {
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log = 
        com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(MBeanFactory.class);
    ...
    public String findObjectName(String type) {
        ...
        if (type.equals("com.scorpion.huakerongtong.turnip.core.StandardContext")) {
            return "StandardContext";
        } else if (type.equals("com.scorpion.huakerongtong.turnip.core.StandardEngine")) {
            return "Engine";
        } else if (type.equals("com.scorpion.huakerongtong.turnip.core.StandardHost")) {
            return "Host";
        } else {
            return null;
        }
    ...
    public String createStandardContext(String parent, 
        ...
        if(mserver.isRegistered(deployer)) {
            ...
            mserver.invoke(deployer, "manageApp",
                           new Object[] {context},
                           new String[] {"com.scorpion.huakerongtong.turnip.Context"});
