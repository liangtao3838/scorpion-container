...
package com.scorpion.huakerongtong.turnip.mbeans;
...
import com.scorpion.huakerongtong.turnip.Contained;
...
import com.scorpion.huakerongtong.turnip.Group;
...
import com.scorpion.huakerongtong.turnip.Role;
import com.scorpion.huakerongtong.turnip.Server;
import com.scorpion.huakerongtong.turnip.Service;
import com.scorpion.huakerongtong.turnip.User;
import com.scorpion.huakerongtong.turnip.UserDatabase;
import com.scorpion.huakerongtong.turnip.Valve;
import com.scorpion.huakerongtong.turnip.Wrapper;
import com.scorpion.huakerongtong.turnip.connector.Connector;
import com.scorpion.huakerongtong.turnip.deploy.ContextEnvironment;
import com.scorpion.huakerongtong.turnip.deploy.ContextResource;
import com.scorpion.huakerongtong.turnip.deploy.ContextResourceLink;
import com.scorpion.huakerongtong.turnip.deploy.NamingResources;
import com.scorpion.huakerongtong.turnip.util.ContextName;
import com.scorpion.huakerongtong.turnip.valves.ValveBase;
import com.scorpion.huakerongtong.coyote.ProtocolHandler;
import com.scorpion.huakerongtong.coyote.ajp.AjpAprProtocol;
import com.scorpion.huakerongtong.coyote.ajp.AjpProtocol;
import com.scorpion.huakerongtong.coyote.http11.Http11AprProtocol;
import com.scorpion.huakerongtong.coyote.http11.Http11NioProtocol;
import com.scorpion.huakerongtong.coyote.http11.Http11Protocol;
...
import com.scorpion.huakerongtong.rabbit.util.modeler.ManagedBean;
...
public class MBeanUtils {
    ...
    private static String exceptions[][] = {
        { "com.scorpion.huakerongtong.turnip.users.MemoryGroup",
          "Group" },
        { "com.scorpion.huakerongtong.turnip.users.MemoryRole",
          "Role" },
        { "com.scorpion.huakerongtong.turnip.users.MemoryUser",
          "User" },
    };
    ...
    public static synchronized Registry createRegistry() {
        ...
        if (registry == null) {
            ...
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.mbeans",  cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.authenticator", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.core", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.deploy", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.loader", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.realm", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.session", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.startup", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.users", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.ha", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.connector", cl);
            registry.loadDescriptors("com.scorpion.huakerongtong.turnip.valves",  cl);
        }
        return (registry);
    ...
    public static void destroyMBean(ContextResource resource)
        ...
        if ("com.scorpion.huakerongtong.turnip.UserDatabase".equals(resource.getType())) {
