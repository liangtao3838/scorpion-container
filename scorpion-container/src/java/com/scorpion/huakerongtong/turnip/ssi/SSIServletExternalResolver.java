 ...
 */
package com.scorpion.huakerongtong.turnip.ssi;
...
import com.scorpion.huakerongtong.coyote.Constants;
    ...
    public String getFileText(String originalPath, boolean virtual)
        ...
        try {
            ...
            if (retVal.equals("") && !req.getMethod().equalsIgnoreCase(
                    com.scorpion.huakerongtong.coyote.http11.Constants.HEAD)) {
