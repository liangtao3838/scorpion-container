...
package com.scorpion.huakerongtong.turnip.tribes.transport.bio;
...
import com.scorpion.huakerongtong.turnip.tribes.transport.AbstractSender;
import com.scorpion.huakerongtong.turnip.tribes.transport.Constants;
import com.scorpion.huakerongtong.turnip.tribes.transport.SenderState;
...
public class BioSender extends AbstractSender {
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log = com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(BioSender.class);
     ...
     * @see com.scorpion.huakerongtong.turnip.tribes.transport.DataSender#connect()
     */
    @Override
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.tribes.transport.DataSender#disconnect()
     */
    @Override
        ...
        try {
            ...
            while ((i != -1) && (bytesRead < Constants.ACK_COMMAND.length)) {
                ...
                if (ackbuf.doesPackageExist() ) {
                    ...
                    ackReceived = Arrays.equals(ackcmd,com.scorpion.huakerongtong.turnip.tribes.transport.Constants.ACK_DATA);
                    failAckReceived = Arrays.equals(ackcmd,com.scorpion.huakerongtong.turnip.tribes.transport.Constants.FAIL_ACK_DATA);
            ...
            if (!ackReceived) {
                ...
                throw new RemoteProcessException("Received a failed ack:com.scorpion.huakerongtong.turnip.tribes.transport.Constants.FAIL_ACK_DATA");
            }
        } catch (IOException x) {
