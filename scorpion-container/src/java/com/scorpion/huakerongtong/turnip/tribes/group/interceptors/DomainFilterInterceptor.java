...
public class DomainFilterInterceptor extends ChannelInterceptorBase {
    ...
    public void setDomain(String domain) {
        ...
        if (domain.startsWith("{"))
            setDomain(com.scorpion.huakerongtong.turnip.tribes.util.Arrays.fromString(domain));
        else
            setDomain(com.scorpion.huakerongtong.turnip.tribes.util.Arrays.convert(domain));
    }
