...
package com.scorpion.huakerongtong.turnip.ha.tcp;
...
import com.scorpion.huakerongtong.turnip.Container;
import com.scorpion.huakerongtong.turnip.Context;
import com.scorpion.huakerongtong.turnip.Engine;
import com.scorpion.huakerongtong.turnip.Host;
import com.scorpion.huakerongtong.turnip.Lifecycle;
import com.scorpion.huakerongtong.turnip.LifecycleEvent;
import com.scorpion.huakerongtong.turnip.LifecycleException;
import com.scorpion.huakerongtong.turnip.LifecycleListener;
import com.scorpion.huakerongtong.turnip.LifecycleState;
import com.scorpion.huakerongtong.turnip.Manager;
import com.scorpion.huakerongtong.turnip.Valve;
import com.scorpion.huakerongtong.turnip.ha.CatalinaCluster;
import com.scorpion.huakerongtong.turnip.ha.ClusterDeployer;
import com.scorpion.huakerongtong.turnip.ha.ClusterListener;
import com.scorpion.huakerongtong.turnip.ha.ClusterManager;
import com.scorpion.huakerongtong.turnip.ha.ClusterMessage;
import com.scorpion.huakerongtong.turnip.ha.ClusterValve;
import com.scorpion.huakerongtong.turnip.ha.session.ClusterSessionListener;
import com.scorpion.huakerongtong.turnip.ha.session.DeltaManager;
import com.scorpion.huakerongtong.turnip.ha.session.JvmRouteBinderValve;
import com.scorpion.huakerongtong.turnip.ha.session.JvmRouteSessionIDBinderListener;
import com.scorpion.huakerongtong.turnip.ha.session.SessionMessage;
import com.scorpion.huakerongtong.turnip.ha.util.IDynamicProperty;
...
import com.scorpion.huakerongtong.turnip.tribes.MembershipListener;
import com.scorpion.huakerongtong.turnip.tribes.group.GroupChannel;
import com.scorpion.huakerongtong.turnip.tribes.group.interceptors.MessageDispatch15Interceptor;
import com.scorpion.huakerongtong.turnip.tribes.group.interceptors.TcpFailureDetector;
...
import com.scorpion.huakerongtong.rabbit.util.IntrospectionUtils;
...
public class SimpleTcpCluster extends LifecycleMBeanBase
     ...
     * @see com.scorpion.huakerongtong.turnip.tribes.group.GroupChannel#heartbeat()
     */
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.ha.CatalinaCluster#addClusterListener(com.scorpion.huakerongtong.turnip.ha.ClusterListener)
     */
    @Override
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.ha.CatalinaCluster#removeClusterListener(com.scorpion.huakerongtong.turnip.ha.ClusterListener)
     */
    @Override
     ...
     * @see com.scorpion.huakerongtong.turnip.Cluster#createManager(java.lang.String)
    ...
    public synchronized Manager createManager(String name) {
        ...
        try {
            ...
            log.error("Unable to clone cluster manager, defaulting to com.scorpion.huakerongtong.turnip.ha.session.DeltaManager", x);
            manager = new com.scorpion.huakerongtong.turnip.ha.session.DeltaManager();
        } finally {
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.Cluster#removeManager(Manager)
     */
    @Override
     ...
     * Get Manager
     * 
     * @see com.scorpion.huakerongtong.turnip.ha.CatalinaCluster#getManager(java.lang.String)
     */
    @Override
     ...
     * @see com.scorpion.huakerongtong.turnip.ha.deploy.FarmWarDeployer#backgroundProcess()
     * @see com.scorpion.huakerongtong.turnip.tribes.group.GroupChannel#heartbeat()
     * @see com.scorpion.huakerongtong.turnip.tribes.group.GroupChannel.HeartbeatThread#run()
     * 
     */
    @Override
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.LifecycleListener#lifecycleEvent(com.scorpion.huakerongtong.turnip.LifecycleEvent)
     * @deprecated  Unused - will be removed in Tomcat 8.0.x
     */
    @Override
    @Deprecated
     ...
     * of {@link com.scorpion.huakerongtong.turnip.util.LifecycleBase#startInternal()}.
     *
     ...
     * of {@link com.scorpion.huakerongtong.turnip.util.LifecycleBase#stopInternal()}.
     *
     * @exception LifecycleException if this component detects a fatal error
     *  that prevents this component from being used
     */
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.ha.CatalinaCluster#send(com.scorpion.huakerongtong.turnip.ha.ClusterMessage)
     */
    @Override
     ...
     * @see com.scorpion.huakerongtong.turnip.ha.CatalinaCluster#send(com.scorpion.huakerongtong.turnip.ha.ClusterMessage,
     *      com.scorpion.huakerongtong.turnip.tribes.Member)
     */
    @Override
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.tribes.MembershipListener#memberAdded(com.scorpion.huakerongtong.turnip.tribes.Member)
     */
    @Override
     ...
     * 
     * @see com.scorpion.huakerongtong.turnip.tribes.MembershipListener#memberDisappeared(com.scorpion.huakerongtong.turnip.tribes.Member)
     */
    @Override
    ...
    /**
     * 
     * @see com.scorpion.huakerongtong.turnip.Cluster#setProtocol(java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.scorpion.huakerongtong.turnip.Cluster#getProtocol()
     */
    @Override
