...
public class Constants {
    ...
    public static final String Package = "com.scorpion.huakerongtong.turnip.authenticator";
    ...
    public static final String SINGLE_SIGN_ON_COOKIE =
        System.getProperty(
                "com.scorpion.huakerongtong.turnip.authenticator.Constants.SSO_SESSION_COOKIE_NAME",
                "JSESSIONIDSSO");
    ...
    public static final String REQ_SSOID_NOTE =
      "com.scorpion.huakerongtong.turnip.request.SSOID";
    ...
    public static final String SESS_PASSWORD_NOTE =
      "com.scorpion.huakerongtong.turnip.session.PASSWORD";
    ...
    public static final String SESS_USERNAME_NOTE =
      "com.scorpion.huakerongtong.turnip.session.USERNAME";
    ...
    public static final String FORM_PRINCIPAL_NOTE =
        "com.scorpion.huakerongtong.turnip.authenticator.PRINCIPAL";
    ...
    public static final String FORM_REQUEST_NOTE =
        "com.scorpion.huakerongtong.turnip.authenticator.REQUEST";
