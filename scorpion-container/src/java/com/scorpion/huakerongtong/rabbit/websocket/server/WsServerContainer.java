...
import com.scorpion.huakerongtong.rabbit.websocket.WsWebSocketContainer;
import com.scorpion.huakerongtong.rabbit.websocket.pojo.PojoEndpointServer;
import com.scorpion.huakerongtong.rabbit.websocket.pojo.PojoMethodMapping;
...
public class WsServerContainer extends WsWebSocketContainer
    ...
    private volatile boolean enforceNoAddAfterHandshake =
            com.scorpion.huakerongtong.rabbit.websocket.Constants.STRICT_SPEC_COMPLIANCE;
