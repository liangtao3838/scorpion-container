...
import com.scorpion.huakerongtong.rabbit.util.net.SSLSessionManager;
...
class JSSESupport implements SSLSupport, SSLSessionManager {
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log =
        com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(JSSESupport.class);
    ...
    /**
     * Copied from <code>com.scorpion.huakerongtong.rabbit.valves.CertificateValve</code>
     */
    @Override
