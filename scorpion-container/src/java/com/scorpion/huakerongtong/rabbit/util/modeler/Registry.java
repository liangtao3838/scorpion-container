...
package com.scorpion.huakerongtong.rabbit.util.modeler;
...
import com.scorpion.huakerongtong.rabbit.util.modeler.modules.ModelerSource;
...
//                    localRegistry.key=key;
            ...
            throws Exception
    {
        ...
        if( type.indexOf( ".") < 0 ) {
            type="com.scorpion.huakerongtong.rabbit.util.modeler.modules." + type;
        }
