...
public final class CookieSupport {
    ...
    static {
        ...
        ALLOW_EQUALS_IN_VALUE = Boolean.parseBoolean(System.getProperty(
                "com.scorpion.huakerongtong.rabbit.util.http.ServerCookie.ALLOW_EQUALS_IN_VALUE",
                "false"));

        ALLOW_HTTP_SEPARATORS_IN_V0 = Boolean.parseBoolean(System.getProperty(
                "com.scorpion.huakerongtong.rabbit.util.http.ServerCookie.ALLOW_HTTP_SEPARATORS_IN_V0",
                "false"));

        String alwaysAddExpires = System.getProperty(
        "com.scorpion.huakerongtong.rabbit.util.http.ServerCookie.ALWAYS_ADD_EXPIRES");
        ...
        String preserveCookieHeader = System.getProperty(
                "com.scorpion.huakerongtong.rabbit.util.http.ServerCookie.PRESERVE_COOKIE_HEADER");
        ...
        ALLOW_NAME_ONLY = Boolean.parseBoolean(System.getProperty(
                "com.scorpion.huakerongtong.rabbit.util.http.ServerCookie.ALLOW_NAME_ONLY",
                "false"));
