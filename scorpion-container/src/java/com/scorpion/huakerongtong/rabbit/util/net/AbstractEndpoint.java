...
import com.scorpion.huakerongtong.rabbit.util.threads.LimitLatch;
import com.scorpion.huakerongtong.rabbit.util.threads.ResizableExecutor;
import com.scorpion.huakerongtong.rabbit.util.threads.TaskQueue;
import com.scorpion.huakerongtong.rabbit.util.threads.TaskThreadFactory;
import com.scorpion.huakerongtong.rabbit.util.threads.ThreadPoolExecutor;
/**
 *
 * @author fhanik
 * @author Mladen Turk
...
public abstract class AbstractEndpoint<S> {
    ...
    // -------------------------------------------------------------- Constants
    protected static final StringManager sm = StringManager.getManager("com.scorpion.huakerongtong.rabbit.util.net.res");
     ...
     * without the {@link com.scorpion.huakerongtong.coyote.ProtocolHandler} being aware of the
     * properties available on those sub-components. One example of such a
     * sub-component is the
     * {@link com.scorpion.huakerongtong.rabbit.util.net.ServerSocketFactory}.
     */
     ...
     * {@link com.scorpion.huakerongtong.coyote.ProtocolHandler} needs to be made available to
