...
package com.scorpion.huakerongtong.rabbit.util.net.jsse;
...
import com.scorpion.huakerongtong.rabbit.util.file.ConfigFileLoader;
import com.scorpion.huakerongtong.rabbit.util.net.AbstractEndpoint;
import com.scorpion.huakerongtong.rabbit.util.net.Constants;
import com.scorpion.huakerongtong.rabbit.util.net.SSLUtil;
import com.scorpion.huakerongtong.rabbit.util.net.ServerSocketFactory;
...
public class JSSESocketFactory implements ServerSocketFactory, SSLUtil {
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log =
        com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(JSSESocketFactory.class);
    private static final StringManager sm =
        StringManager.getManager("com.scorpion.huakerongtong.rabbit.util.net.jsse.res");
