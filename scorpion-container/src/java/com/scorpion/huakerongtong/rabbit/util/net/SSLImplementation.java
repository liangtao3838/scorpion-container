...
public abstract class SSLImplementation {
    private static final com.scorpion.huakerongtong.juli.logging.Log logger = com.scorpion.huakerongtong.juli.logging.LogFactory
    ...
    private static final String JSSEImplementationClass =
        "com.scorpion.huakerongtong.rabbit.util.net.jsse.JSSEImplementation";
    ...
    public static SSLImplementation getInstance(String className)
        ...
        try {
            ...
            if (JSSEImplementationClass.equals(className)) {
                return new com.scorpion.huakerongtong.rabbit.util.net.jsse.JSSEImplementation();
            }
