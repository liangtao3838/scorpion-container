...
public final class Constants {
    ...
    public static final String Package = "com.scorpion.huakerongtong.coyote";
    ...
    public static final boolean USE_CUSTOM_STATUS_MSG_IN_HEADER =
            Boolean.getBoolean("com.scorpion.huakerongtong.coyote.USE_CUSTOM_STATUS_MSG_IN_HEADER");
    ...
    public static final String COMET_SUPPORTED_ATTR =
        "com.scorpion.huakerongtong.rabbit.comet.support";
     ...
     *
     * @see com.scorpion.huakerongtong.rabbit.comet.CometEvent#setTimeout(int)
     */
    public static final String COMET_TIMEOUT_SUPPORTED_ATTR =
        "com.scorpion.huakerongtong.rabbit.comet.timeout.support";
    ...
    public static final String COMET_TIMEOUT_ATTR =
        "com.scorpion.huakerongtong.rabbit.comet.timeout";
    ...
    public static final String SENDFILE_SUPPORTED_ATTR =
        "com.scorpion.huakerongtong.rabbit.sendfile.support";
    ...
    public static final String SENDFILE_FILENAME_ATTR =
        "com.scorpion.huakerongtong.rabbit.sendfile.filename";
    ...
    public static final String SENDFILE_FILE_START_ATTR =
        "com.scorpion.huakerongtong.rabbit.sendfile.start";
    ...
    public static final String SENDFILE_FILE_END_ATTR =
        "com.scorpion.huakerongtong.rabbit.sendfile.end";
    ...
    public static final String REMOTE_ADDR_ATTRIBUTE =
            "com.scorpion.huakerongtong.rabbit.remoteAddr";
}
