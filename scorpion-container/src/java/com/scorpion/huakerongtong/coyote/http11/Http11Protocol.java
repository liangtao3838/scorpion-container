...
import com.scorpion.huakerongtong.coyote.http11.upgrade.BioProcessor;
...
import com.scorpion.huakerongtong.rabbit.util.net.JIoEndpoint;
import com.scorpion.huakerongtong.rabbit.util.net.JIoEndpoint.Handler;
...
public class Http11Protocol extends AbstractHttp11JsseProtocol<Socket> {
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log
        = com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(Http11Protocol.class);
    ...
    protected static class Http11ConnectionHandler
        ...
        protected Processor<Socket> createUpgradeProcessor(
                ...
                throws IOException {
            return new com.scorpion.huakerongtong.coyote.http11.upgrade.UpgradeBioProcessor(
                    socket, inbound);
        }
