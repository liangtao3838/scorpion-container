...
import com.scorpion.huakerongtong.coyote.AbstractProtocol;
import com.scorpion.huakerongtong.coyote.Processor;
import com.scorpion.huakerongtong.coyote.http11.upgrade.NioProcessor;
...
import com.scorpion.huakerongtong.rabbit.util.net.NioEndpoint.Handler;
import com.scorpion.huakerongtong.rabbit.util.net.SSLImplementation;
...
public class Http11NioProtocol extends AbstractHttp11JsseProtocol<NioChannel> {
    ...
    protected static class Http11ConnectionHandler
        ...
        protected Processor<NioChannel> createUpgradeProcessor(
                ...
                throws IOException {
            return new com.scorpion.huakerongtong.coyote.http11.upgrade.UpgradeNioProcessor(
                    socket, inbound,
