...
import com.scorpion.huakerongtong.rabbit.util.http.parser.HttpParser;
...
public class InternalNioInputBuffer extends AbstractInputBuffer<NioChannel> {
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log =
        com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(InternalNioInputBuffer.class);
