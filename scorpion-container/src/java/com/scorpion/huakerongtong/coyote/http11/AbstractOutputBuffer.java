...
public abstract class AbstractOutputBuffer<S> implements OutputBuffer{
    ...
    private static final com.scorpion.huakerongtong.juli.logging.Log log
        = com.scorpion.huakerongtong.juli.logging.LogFactory.getLog(AbstractOutputBuffer.class);
 ...
 // --------------------------------------------------- OutputBuffer Methods
    ...
    public void sendStatus() {
        ...
        if (com.scorpion.huakerongtong.coyote.Constants.IS_SECURITY_ENABLED){
