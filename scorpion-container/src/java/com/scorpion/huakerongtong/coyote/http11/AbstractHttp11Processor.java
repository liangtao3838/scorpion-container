 ...
 */
package com.scorpion.huakerongtong.coyote.http11;
...
import com.scorpion.huakerongtong.coyote.AbstractProcessor;
import com.scorpion.huakerongtong.coyote.ActionCode;
import com.scorpion.huakerongtong.coyote.AsyncContextCallback;
import com.scorpion.huakerongtong.coyote.ErrorState;
import com.scorpion.huakerongtong.coyote.RequestInfo;
import com.scorpion.huakerongtong.coyote.http11.filters.BufferedInputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.ChunkedInputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.ChunkedOutputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.GzipOutputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.IdentityInputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.IdentityOutputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.SavedRequestInputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.VoidInputFilter;
import com.scorpion.huakerongtong.coyote.http11.filters.VoidOutputFilter;
...
import com.scorpion.huakerongtong.rabbit.util.buf.Ascii;
import com.scorpion.huakerongtong.rabbit.util.buf.ByteChunk;
import com.scorpion.huakerongtong.rabbit.util.buf.HexUtils;
...
import com.scorpion.huakerongtong.rabbit.util.http.MimeHeaders;
import com.scorpion.huakerongtong.rabbit.util.log.UserDataHelper;
import com.scorpion.huakerongtong.rabbit.util.net.AbstractEndpoint;
import com.scorpion.huakerongtong.rabbit.util.net.AbstractEndpoint.Handler.SocketState;
import com.scorpion.huakerongtong.rabbit.util.net.SocketStatus;
import com.scorpion.huakerongtong.rabbit.util.net.SocketWrapper;
...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
     ...
     */
    @Deprecated
    protected com.scorpion.huakerongtong.coyote.http11.upgrade.UpgradeInbound upgradeInbound = null;
    ...
    public final void action(ActionCode actionCode, Object param) {
        ...
        case UPGRADE_TOMCAT: {
            upgradeInbound = (com.scorpion.huakerongtong.coyote.http11.upgrade.UpgradeInbound) param;
    ...
    public SocketState process(SocketWrapper<S> socketWrapper)
        ...
        rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_PARSE);
        ...
        while (!getErrorState().isError() && keepAlive && !comet && !isAsync() &&
            ...
            if (!getErrorState().isError()) {
                ...
                rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_PREPARE);
                try {
                    prepareRequest();
                } catch (Throwable t) {
                    ExceptionUtils.handleThrowable(t);
            ...
            if (!getErrorState().isError()) {
                try {
                    rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_SERVICE);
            ...
            rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_ENDINPUT);
            ...
            rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_ENDOUTPUT);
            ...
            rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_KEEPALIVE);
        ...
        rp.setStage(com.scorpion.huakerongtong.coyote.Constants.STAGE_ENDED);
    ...
    protected void prepareRequest() {
        ...
        if (endpoint.getUseSendfile()) {
            request.setAttribute(
                    com.scorpion.huakerongtong.coyote.Constants.SENDFILE_SUPPORTED_ATTR,
                    Boolean.TRUE);
        }
        ...
        if (endpoint.getUseComet()) {
            request.setAttribute(
                    com.scorpion.huakerongtong.coyote.Constants.COMET_SUPPORTED_ATTR,
                    Boolean.TRUE);
        }
        // Advertise comet timeout support
        if (endpoint.getUseCometTimeout()) {
            request.setAttribute(
                    com.scorpion.huakerongtong.coyote.Constants.COMET_TIMEOUT_SUPPORTED_ATTR,
                    Boolean.TRUE);
        }
        if (getErrorState().isError()) {
    ...
    @Deprecated
    @Override
    public com.scorpion.huakerongtong.coyote.http11.upgrade.UpgradeInbound getUpgradeInbound() {
