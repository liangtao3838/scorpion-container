...
public class SavedRequestInputFilter implements InputFilter {
     ...
     */
    @Override
    public int doRead(ByteChunk chunk, com.scorpion.huakerongtong.coyote.Request request)
            throws IOException {
        int writeLength = 0;
     ...
     */
    @Override
    public void setRequest(com.scorpion.huakerongtong.coyote.Request request) {
