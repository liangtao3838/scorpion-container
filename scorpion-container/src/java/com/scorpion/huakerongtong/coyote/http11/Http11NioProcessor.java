...
import com.scorpion.huakerongtong.rabbit.util.net.NioChannel;
import com.scorpion.huakerongtong.rabbit.util.net.NioEndpoint;
import com.scorpion.huakerongtong.rabbit.util.net.NioEndpoint.KeyAttachment;
import com.scorpion.huakerongtong.rabbit.util.net.SSLSupport;
import com.scorpion.huakerongtong.rabbit.util.net.SecureNioChannel;
import com.scorpion.huakerongtong.rabbit.util.net.SendfileKeepAliveState;
...
public class Http11NioProcessor extends AbstractHttp11Processor<NioChannel> {
    ...
    public void actionInternal(ActionCode actionCode, Object param) {
        ...
        case COMET_CLOSE: {
            ...
            RequestInfo rp = request.getRequestProcessor();
            if (rp.getStage() != com.scorpion.huakerongtong.coyote.Constants.STAGE_SERVICE) {
    ...
    protected boolean prepareSendfile(OutputFilter[] outputFilters) {
        ...
        if (fileName != null) {
            ...
            sendfileData.pos = ((Long) request.getAttribute(
                    com.scorpion.huakerongtong.coyote.Constants.SENDFILE_FILE_START_ATTR)).longValue();
            sendfileData.length = ((Long) request.getAttribute(
                    com.scorpion.huakerongtong.coyote.Constants.SENDFILE_FILE_END_ATTR)).longValue() - sendfileData.pos;
            return true;
        }
        return false;
    }
